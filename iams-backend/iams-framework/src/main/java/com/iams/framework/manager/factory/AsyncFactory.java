package com.iams.framework.manager.factory;

import java.util.TimerTask;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.iams.common.constant.Constants;
import com.iams.common.utils.LogUtils;
...
import com.iams.system.domain.SysOperLog;
import com.iams.system.service.ISysLogininforService;
import com.iams.system.service.ISysOperLogService;
            ...
            final Object... args)
    {
        ...
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                else if(Constants.LOGIN_WARNING.equals(status))
                {
                    logininfor.setStatus(Constants.WARNING);
                }
                // 插入数据
