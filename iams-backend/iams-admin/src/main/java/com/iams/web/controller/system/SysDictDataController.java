...
import com.iams.system.service.impl.SysDictDataServiceImpl;
...
import com.iams.system.service.ISysDictTypeService;
...
public class SysDictDataController extends BaseController
{
    ...
    public AjaxResult importData(MultipartFile file, boolean updateSupport, String dictType) throws Exception
    {
        ExcelUtil<SysDictData> util = new ExcelUtil<SysDictData>(SysDictData.class);
        List<SysDictData> userList = util.importExcel(file.getInputStream());
        String operName = getUsername();
        String message = dictDataService.importDictData(userList, updateSupport, operName, dictType);
