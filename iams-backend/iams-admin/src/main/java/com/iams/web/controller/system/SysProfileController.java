...
import com.iams.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult profile()
    {
        ...
        // 获取用户岗位编码 - 使用你现有的方法
        Set<String> postCodes = postService.selectPostCodeByUserId(user.getUserId());
    ...
    public AjaxResult updatePwd(@RequestParam Map<String, String> params)
    {
