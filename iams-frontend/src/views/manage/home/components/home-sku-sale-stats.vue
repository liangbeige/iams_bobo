<template>
  <div class="box home-sku-sale-stats bgc2">
    <div class="header">
      <div class="title">
        归档统计<span class="sub-title">{{ start }} ~ {{ end }}</span>
      </div>
    </div>
    <div class="body">
      <div class="stats">
      ...
      <div class="stats">
        <div class="item">
          <div class="num color3 text-shadow2">
            {{
              props.skuData?.data2 > 10000
                ? (props.skuData?.data2 / 10000).toFixed(2)
                : props.skuData?.data2
            }}
          </div>
          <div class="text color4">
            待归档（{{ props.skuData?.data3 > 10000 ? '万份' : '份' }}）
          </div>
        </div>
      </div>
    </div>
