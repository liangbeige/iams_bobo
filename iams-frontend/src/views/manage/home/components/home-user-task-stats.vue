<template>
  <div class="box home-user-task-stats bgc1">
    <div class="header">
      <div class="title">
        借阅统计<span class="sub-title">{{ start }} ~ {{ end }}</span>
      </div>
    </div>
      ...
      <div class="stats">
        <div class="item">
          <div class="num color1 text-shadow1">
            {{ props.taskData?.data1 }}
          </div>
          <div class="text color2">借阅总次数</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          <div class="num color1 text-shadow1">
            {{
              props.taskData?.data2
            }}
          </div>
          <div class="text color2">归还数量</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          <div class="num color1 text-shadow1">
            {{
              props.taskData?.data3
            }}
          </div>
          <div class="text color2">借出数量</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          <div class="num color1 text-shadow1">
            {{ props.taskData?.data4 }}
          </div>
          <div class="text color2">逾期待归还数量</div>
        </div>
      </div>
    </div>
  </div>
